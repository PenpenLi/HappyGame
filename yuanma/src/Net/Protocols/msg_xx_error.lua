...
kEC = {
    ...
    XE_INVALID_TRANSFER = 10005,  --// 无效连接 重新登陆
    ...
    XG_ROLE_VIP_LEVEL_LIMIT = 20013,  --// 角色vip等级限制
    XG_ADD_STRENGTH_LIMIT = 20014,  --// 获得或者购买体力值达到上限
    ...
    XG_CHEER_NO_FRIEND = 20500,  --// 没有此助阵好友
    XG_CHEER_NO_TIME = 20501,  --// 助阵时间未到
    XG_ACTIVITY_NO_OPEN = 20601,  --// 活动未开启
    XG_ACTIVITY_ONLINE_NO_TIME = 20602,  --// 在线时间不足
    XG_ACTIVITY_LEVEL_LIMIT = 20603,  --// 等级不足
    XG_ACTIVITY_HAS_GAIN = 20604,  --// 已经领取奖励
    XG_ACTIVITY_HAS_SIGN = 20605,  --// 已经签到
    ...
    XA_FREEZE_DEVICE = 30005,  --// 设备Id被冻结
    XA_FREEZE_USERID = 30006,  --// 用户Id被冻结
