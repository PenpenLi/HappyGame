--游戏的第一章节界面
local StoryCopysItem04Params = class("StoryCopysItem04Params")

function StoryCopysItem04Params:ctor()
    self._pCCS = cc.CSLoader:createNode("StoryCopysItem04.csb")
	--大背景板
    ...
    --副本节点集合
    self._tNodeCopy ={self._pnodecopy01,self._pnodecopy02,self._pnodecopy03,self._pnodecopy04,self._pnodecopy05,self._pnodecopy06,self._pnodecopy07,self._pnodecopy08,self._pnodecopy09,self._pnodecopy10,self._pnodecopy11,self._pnodecopy12}
    --下一章按钮
...
function StoryCopysItem04Params:create()
    local params = StoryCopysItem04Params.new()
    return params  
end

return StoryCopysItem04Params
