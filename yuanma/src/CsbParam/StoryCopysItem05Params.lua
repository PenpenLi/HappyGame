--游戏的第一章节界面
local StoryCopysItem05Params = class("StoryCopysItem05Params")

function StoryCopysItem05Params:ctor()
    self._pCCS = cc.CSLoader:createNode("StoryCopysItem05.csb")
	--大背景板
    ...
    --副本节点集合
    self._tNodeCopy ={self._pnodecopy01,self._pnodecopy02,self._pnodecopy03,self._pnodecopy04,self._pnodecopy05,self._pnodecopy06,self._pnodecopy07,self._pnodecopy08,self._pnodecopy09,self._pnodecopy10,self._pnodecopy11}
    --下一章按钮
...
function StoryCopysItem05Params:create()
    local params = StoryCopysItem05Params.new()
    return params  
end

return StoryCopysItem05Params
