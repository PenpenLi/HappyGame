...
function AdvancedPetPanelParams:ctor()
    ...
    --宠物等级
    self._pLvText = self._pAdvancedPetBg:getChildByName("LvText")
    --战斗力艺术字数值
    ...
    --宠物升阶材料1底板
    self._pJjieBg = self._pAdvancedPetBg:getChildByName("JjieBg")
    --宠物升阶材料1底板 
    self._pIconBg1 = self._pAdvancedPetBg:getChildByName("IconBg1")
    --升阶材料1数量
    self._pIcon1Num = self._pJjieBg:getChildByName("Icon1Num")
    --宠物升阶材料1图标
