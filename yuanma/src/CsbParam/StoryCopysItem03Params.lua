--游戏的第一章节界面
local StoryCopysItem03Params = class("StoryCopysItem03Params")

function StoryCopysItem03Params:ctor()
    self._pCCS = cc.CSLoader:createNode("StoryCopysItem03.csb")
	--大背景板
...
function StoryCopysItem03Params:create()
    local params = StoryCopysItem03Params.new()
    return params  
end

return StoryCopysItem03Params
