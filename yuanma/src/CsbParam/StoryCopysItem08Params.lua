--游戏的第一章节界面
local StoryCopysItem08Params = class("StoryCopysItem08Params")

function StoryCopysItem08Params:ctor()
    self._pCCS = cc.CSLoader:createNode("StoryCopysItem08.csb")
	--大背景板
...
function StoryCopysItem08Params:create()
    local params = StoryCopysItem08Params.new()
    return params  
end

return StoryCopysItem08Params
