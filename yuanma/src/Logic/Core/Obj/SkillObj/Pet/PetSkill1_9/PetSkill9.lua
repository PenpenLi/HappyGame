...
-- All Rights Reserved.
--==================================================
-- filename:  PetSkill9.lua
-- author:    taoye
-- e-mail:    553681974@qq.com
-- created:   2015/7/24
-- descrip:   宠物技能攻击9    大圣
--===================================================
local PetSkill9 = class("PetSkill9",function(master, skillInfo)
    return require("SkillObj"):create(master, skillInfo)
end)

-- 构造函数
function PetSkill9:ctor()
    self._strName = "PetSkill9"                            -- 技能名称
    self._kTypeID = kType.kSkill.kID.kPetSkill9            -- 技能对象类型
...
-- 创建函数
function PetSkill9:create(master,skillInfo)
    local skill = PetSkill9.new(master, skillInfo)
    skill:dispose()
    return skill
end

-- 处理函数
function PetSkill9:dispose()
    ------------------- 初始化 ------------------------  
    -- 创建状态机
...
-- 退出函数
function PetSkill9:onExitPetSkill9()    
    self:onExitSkillObj()
end

-- 循环更新
function PetSkill9:update(dt)
    self:updateSkillObj(dt)
end

-- 创建状态机
function PetSkill9:initStateMachine()
...
-- 初始化动作帧事件回调
function PetSkill9:initActionsFrameEvents(index, action)
    if index == 1 then
...
-- 帧事件的处理
function PetSkill9:procActionsFrameEvents()
...
-------------------------------------------------------------------------------------------------
-- 技能待机状态onEnter时技能操作
function PetSkill9:onEnterIdleDo(state)
...
-- 技能待机状态onExit时技能操作
function PetSkill9:onExitIdleDo()

end

-- 技能待机状态onUpdate时技能操作
function PetSkill9:onUpdateIdleDo(dt)

end
-------------------------------------------------------------------------------------------------
-- 技能吟唱状态onEnter时技能操作
function PetSkill9:onEnterChantDo(state)
    self._pCurState = state
...
-- 技能吟唱状态onExit时技能操作
function PetSkill9:onExitChantDo()

end

-- 技能吟唱状态onUpdate时技能操作
function PetSkill9:onUpdateChantDo(dt)

end
-------------------------------------------------------------------------------------------------
-- 技能执行状态onEnter时技能操作
function PetSkill9:onEnterProcessDo(state)
    self._pCurState = state
...
-- 技能执行状态onExit时技能操作
function PetSkill9:onExitProcessDo()

end

-- 技能执行状态onUpdate时技能操作
function PetSkill9:onUpdateProcessDo(dt)

end
-----------------------------------------------------------------------------------------------------
-- 技能释放状态onEnter时技能操作
function PetSkill9:onEnterReleaseDo(state)
    self._pCurState = state
...
-- 技能释放状态onExit时技能操作
function PetSkill9:onExitReleaseDo()

end

-- 技能释放状态onUpdate时技能操作
function PetSkill9:onUpdateReleaseDo(dt)
