...
-- All Rights Reserved.
--==================================================
-- filename:  MonsterSkill52.lua
-- author:    taoye
-- e-mail:    553681974@qq.com
-- created:   2015/7/23
-- descrip:   怪物技能攻击52  阎王
--===================================================
local MonsterSkill52 = class("MonsterSkill52",function(master, skillInfo)
    return require("SkillObj"):create(master, skillInfo)
end)

-- 构造函数
function MonsterSkill52:ctor()
    self._strName = "MonsterSkill52"                            -- 技能名称
    self._kTypeID = kType.kSkill.kID.kMonsterSkill52            -- 技能对象类型
...
-- 创建函数
function MonsterSkill52:create(master,skillInfo)
    local skill = MonsterSkill52.new(master, skillInfo)
    skill:dispose()
    return skill
end

-- 处理函数
function MonsterSkill52:dispose()
    ------------------- 初始化 ------------------------  
    -- 创建状态机
...
-- 退出函数
function MonsterSkill52:onExitMonsterSkill52()    
    self:onExitSkillObj()
end

-- 循环更新
function MonsterSkill52:update(dt)
    self:updateSkillObj(dt)
end

-- 创建状态机
function MonsterSkill52:initStateMachine()
...
-- 初始化动作帧事件回调
function MonsterSkill52:initActionsFrameEvents(index, action)
    if index == 1 then
...
-- 帧事件的处理
function MonsterSkill52:procActionsFrameEvents()
...
-------------------------------------------------------------------------------------------------
-- 技能待机状态onEnter时技能操作
function MonsterSkill52:onEnterIdleDo(state)
    --print("MonsterSkill52:onEnterIdleDo()")
...
-- 技能待机状态onExit时技能操作
function MonsterSkill52:onExitIdleDo()
--print("MonsterSkill52:onExitIdleDo()")
end

-- 技能待机状态onUpdate时技能操作
function MonsterSkill52:onUpdateIdleDo(dt)

end
-------------------------------------------------------------------------------------------------
-- 技能吟唱状态onEnter时技能操作
function MonsterSkill52:onEnterChantDo(state)
    --print("MonsterSkill52:onEnterChantDo()")
    self._pCurState = state
...
-- 技能吟唱状态onExit时技能操作
function MonsterSkill52:onExitChantDo()
--print("MonsterSkill52:onExitChantDo()")
end

-- 技能吟唱状态onUpdate时技能操作
function MonsterSkill52:onUpdateChantDo(dt)

end
-------------------------------------------------------------------------------------------------
-- 技能执行状态onEnter时技能操作
function MonsterSkill52:onEnterProcessDo(state)
    --print("MonsterSkill52:onEnterProcessDo()")
    self._pCurState = state
...
-- 技能执行状态onExit时技能操作
function MonsterSkill52:onExitProcessDo()
--print("MonsterSkill52:onExitProcessDo()")
end

-- 技能执行状态onUpdate时技能操作
function MonsterSkill52:onUpdateProcessDo(dt)

end
-----------------------------------------------------------------------------------------------------
-- 技能释放状态onEnter时技能操作
function MonsterSkill52:onEnterReleaseDo(state)
    --print("MonsterSkill52:onEnterReleaseDo()")
    self._pCurState = state
...
-- 技能释放状态onExit时技能操作
function MonsterSkill52:onExitReleaseDo()
--print("MonsterSkill52:onExitReleaseDo()")
end

-- 技能释放状态onUpdate时技能操作
function MonsterSkill52:onUpdateReleaseDo(dt)

end

---------------------------------------------------------------------------------------------------------
return MonsterSkill52
