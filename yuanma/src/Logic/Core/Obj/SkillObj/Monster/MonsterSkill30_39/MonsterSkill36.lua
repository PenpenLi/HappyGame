...
-- All Rights Reserved.
--==================================================
-- filename:  MonsterSkill36.lua
-- author:    taoye
-- e-mail:    553681974@qq.com
-- created:   2015/7/21
-- descrip:   怪物技能攻击36   狼
--===================================================
local MonsterSkill36 = class("MonsterSkill36",function(master, skillInfo)
    return require("SkillObj"):create(master, skillInfo)
end)

-- 构造函数
function MonsterSkill36:ctor()
    self._strName = "MonsterSkill36"                            -- 技能名称
    self._kTypeID = kType.kSkill.kID.kMonsterSkill36            -- 技能对象类型
...
-- 创建函数
function MonsterSkill36:create(master,skillInfo)
    local skill = MonsterSkill36.new(master, skillInfo)
    skill:dispose()
    return skill
end

-- 处理函数
function MonsterSkill36:dispose()
    ------------------- 初始化 ------------------------  
    -- 创建状态机
...
-- 退出函数
function MonsterSkill36:onExitMonsterSkill36()    
    self:onExitSkillObj()
end

-- 循环更新
function MonsterSkill36:update(dt)
    self:updateSkillObj(dt)
end

-- 创建状态机
function MonsterSkill36:initStateMachine()
...
-- 初始化动作帧事件回调
function MonsterSkill36:initActionsFrameEvents(index, action)
    if index == 1 then
...
-- 帧事件的处理
function MonsterSkill36:procActionsFrameEvents()
...
-------------------------------------------------------------------------------------------------
-- 技能待机状态onEnter时技能操作
function MonsterSkill36:onEnterIdleDo(state)
    --print("MonsterSkill36:onEnterIdleDo()")
...
-- 技能待机状态onExit时技能操作
function MonsterSkill36:onExitIdleDo()
--print("MonsterSkill36:onExitIdleDo()")
end

-- 技能待机状态onUpdate时技能操作
function MonsterSkill36:onUpdateIdleDo(dt)

end
-------------------------------------------------------------------------------------------------
-- 技能吟唱状态onEnter时技能操作
function MonsterSkill36:onEnterChantDo(state)
    --print("MonsterSkill36:onEnterChantDo()")
    self._pCurState = state
...
-- 技能吟唱状态onExit时技能操作
function MonsterSkill36:onExitChantDo()
--print("MonsterSkill36:onExitChantDo()")
end

-- 技能吟唱状态onUpdate时技能操作
function MonsterSkill36:onUpdateChantDo(dt)

end
-------------------------------------------------------------------------------------------------
-- 技能执行状态onEnter时技能操作
function MonsterSkill36:onEnterProcessDo(state)
    --print("MonsterSkill36:onEnterProcessDo()")
    self._pCurState = state
...
-- 技能执行状态onExit时技能操作
function MonsterSkill36:onExitProcessDo()
--print("MonsterSkill36:onExitProcessDo()")
end

-- 技能执行状态onUpdate时技能操作
function MonsterSkill36:onUpdateProcessDo(dt)

end
-----------------------------------------------------------------------------------------------------
-- 技能释放状态onEnter时技能操作
function MonsterSkill36:onEnterReleaseDo(state)
    --print("MonsterSkill36:onEnterReleaseDo()")
    self._pCurState = state
...
-- 技能释放状态onExit时技能操作
function MonsterSkill36:onExitReleaseDo()
--print("MonsterSkill36:onExitReleaseDo()")

end

-- 技能释放状态onUpdate时技能操作
function MonsterSkill36:onUpdateReleaseDo(dt)

end

---------------------------------------------------------------------------------------------------------
return MonsterSkill36
