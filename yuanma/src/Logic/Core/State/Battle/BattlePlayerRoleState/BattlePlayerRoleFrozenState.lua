...
-- All Rights Reserved.
--==================================================
-- filename:  BattlePlayerRoleFrozenState.lua
-- author:    taoye
-- e-mail:    553681974@qq.com
-- created:   2015/3/13
-- descrip:   战斗中玩家角色冻结状态
--===================================================
local BattlePlayerRoleFrozenState = class("BattlePlayerRoleFrozenState",function()
    return require("State"):create()
end)

-- 构造函数
function BattlePlayerRoleFrozenState:ctor()
    self._strName = "BattlePlayerRoleFrozenState"           -- 状态名称
    self._kTypeID = kType.kState.kBattlePlayerRole.kFrozen  -- 状态类型ID
end

-- 创建函数
function BattlePlayerRoleFrozenState:create()
    local state = BattlePlayerRoleFrozenState.new()
    return state
end

-- 进入函数
function BattlePlayerRoleFrozenState:onEnter(args)
...
-- 退出函数
function BattlePlayerRoleFrozenState:onExit()
...
-- 更新逻辑
function BattlePlayerRoleFrozenState:update(dt)     
    return
end

return BattlePlayerRoleFrozenState
