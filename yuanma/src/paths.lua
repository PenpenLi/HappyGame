...
instFileUtils:addSearchPath("src/Logic/Core/Obj/GameObj/StoryRole")
...
instFileUtils:addSearchPath("src/Logic/Core/Obj/SkillObj/Monster/MonsterSkill60_69")
...
instFileUtils:addSearchPath("src/Logic/Core/State/Battle/BattleOtherPetRoleState")
instFileUtils:addSearchPath("src/Logic/Core/State/Battle/BattleOtherPlayerRoleState")
...
instFileUtils:addSearchPath("src/Logic/Core/State/StoryGuide")
...
instFileUtils:addSearchPath("src/test")
...
instFileUtils:addSearchPath("src/View/StoryGuide")
...
instFileUtils:addSearchPath("src/View/World/TeamCopy")
...
instFileUtils:addSearchPath("src/View/World/FirstCharge")
...
instFileUtils:addSearchPath("src/View/World/Activity/Online")
instFileUtils:addSearchPath("src/View/World/Activity/SignIn")
instFileUtils:addSearchPath("src/View/World/Activity/CumulativeRecharge")
instFileUtils:addSearchPath("src/View/World/Stronger")
instFileUtils:addSearchPath("src/View/World/WorldUiWidget")
instFileUtils:addSearchPath("src/View/World/Rank")
