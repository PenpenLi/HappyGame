...
namespace_ens_begin
bool CnormalMappedSprite::init(const string&texFileName,const string&normalMapFileName,const string&lightFileName)
{
    ...
    //create lightSprite
    {
        ...
        lightSprite_dft->init(lightFileName);
	...
	{
		GLchar * fragSource = (GLchar*) CCString::createWithContentsOfFile(CCFileUtils::sharedFileUtils()->fullPathForFilename("normalMapped.fsh").c_str())->getCString();
