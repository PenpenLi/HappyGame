...
#define WINDOW_TITLE L"GDI画线"	  //为窗体标题定义的宏
...
int g_iPenStyle[7] = {PS_SOLID,PS_DASH,PS_DOT,PS_DASHDOT,PS_DASHDOT,
	PS_NULL,PS_INSIDEFRAME};	//定义画笔的样式数组并初始化
...
VOID Game_Paint(HWND hwnd)
{
	...
	for (int i = 0; i <= 6; i++)
	{
		SelectObject(g_hdc, g_hbrush[i]);	//选用一个画刷
